...
# docs to convert (markdown -> sibling .html). paint-plan.html + pipeline.html are hand-built; skip.
DOCS=(
  changelog.md rebuild_from_raw.md b2a_runbook.md cluster_inventory.md pipeline_workbook.md
  evaluation_plan.md papers/REFERENCES.md papers/VCF_QC.md papers/PIPELINE_QC_BY_PAPER.md
...
for md in "${DOCS[@]}"; do
  ...
  case "$md" in */*) root="../paint-plan.html"; hub="../docs.html";; *) root="paint-plan.html"; hub="docs.html";; esac
  bar="<div class=\"docbar\"><span class=\"b\">PAINT</span> &nbsp;·&nbsp; <a href=\"$root\">← roadmap</a> &nbsp;·&nbsp; <a href=\"$hub\">all docs</a></div>"
  ...
  # the plan's HTML is the curated paint-plan.html, not a generated plan.html
  perl -0pi -e 's{href="((?:\.\./)?)plan\.html"}{href="${1}paint-plan.html"}g' "$out"
