...
*The Altai + Vindija 33.19 + Denisova 3 VCFs share one 2017 snpAD release (same pipeline, reference, filters, one README) → most directly comparable. Chagyrskaya 8 and Denisova 25 are separate releases with their own masks — apply each release's FilterBed and harmonize before merging (see `VCF_QC.md`). Denisova 25 is a **preprint** → treat as provisional; accessions may change.*
...
| **Mezmaiskaya 1** | Mezmaiskaya, Russia · Neanderthal (~65 ka) | ~0.5× + 1.4× ≈ 1.9× | Prüfer et al. 2017 (added); Prüfer 2014 (orig.) | 10.1126/science.aao1887 | ENA **PRJEB21195**; EVA `Mezmaiskaya1/` | ✅ (Prüfer 2017 pdf) |
